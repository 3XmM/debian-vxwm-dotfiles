...
libxcb-present-dev libxcb-xinerama0-dev libxcb-glx0-dev libpixman-
...
# Настройка Alacritty (если в ваших дотфайлах есть его конфиг)
mkdir -p ~/.config/alacritty
if [ -d ~/debiandots/alacritty ]; then
    cp -r ~/debiandots/alacritty/* ~/.config/alacritty/
    echo "-> Конфигурация Alacritty успешно скопирована."
fi
