...
static MAYBE_CONST char normbgcolor[]           = "#0A0A0A"; // Глубокий черный (как фон Alacritty)
static MAYBE_CONST char normbordercolor[]       = "#1A1A1A"; // Темно-серый бордюр неактивного окна
static MAYBE_CONST char normfgcolor[]           = "#E5E5E5"; // Чистый светло-серый текст
static MAYBE_CONST char selfgcolor[]            = "#FFFFFF"; // Белый текст на активном теге/окне
static MAYBE_CONST char selbordercolor[]        = "#FF003C"; // Ярко-алый бордюр активного окна (киберпанк)
static MAYBE_CONST char selbgcolor[]            = "#D6002A"; // Основной красный для выделенного тега
...
const char *wallselect_cmd[] = { "env", "NO_NEOFETCH=1", "alacritty", "--class", "WallSelect", "-e", "/home/danil/.local/bin/wallselect", NULL };
...
{ MODKEY|ShiftMask,             XK_w,      spawn,          {.v = wallselect_cmd } },
  ...
  { MODKEY,                       XK_c,      enhancedtogglefloating, {0} }, //enhanced toggle floating bind.
#endif
#if GAPS
